...
class HTMLTemplateInvoiceDeliverySlipCore extends HTMLTemplate
{
    public $order;
    ...
    public function getContent()
    {
        ...
        $country = Country::getNameById((int) Context::getContext()->language->id,(int) $invoice_address->id_country);
