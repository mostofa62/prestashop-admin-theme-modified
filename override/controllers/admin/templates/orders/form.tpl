...
<script type="text/javascript">
	...
	function updateAddressesList(addresses, id_address_delivery, id_address_invoice)
	{
		...
		$.each(addresses, function() {
			...
			addresses_delivery_options += '<option value="'+this.id_address+'" '+(this.id_address == id_address_delivery ? 'selected="selected"' : '')+'>'+this.name+'</option>';
			addresses_invoice_options += '<option value="'+this.id_address+'" '+(this.id_address == id_address_invoice ? 'selected="selected"' : '')+'>'+this.name+'</option>';
		});
