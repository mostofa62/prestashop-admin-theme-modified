...
namespace Customerextend\Controller\Admin;
...
class CustomerController extends AbstractAdminController
{
        ...
        try {
            ...
            if ($customerId = $result->getIdentifiableObjectId()) {
                ...
                if ($request->query->has('submitFormAjax')) {
                    ...
                    $this->notifyCustomer(array(
                    //'_POST' => $_POST,
                    'newCustomer' => new \Customer($customerId)
                    ));

                    return $this->render('@PrestaShop/Admin/Sell/Customer/modal_create_success.html.twig', [
                        'customerId' => $customerId,
                        'customerEmail' => $customerInformation->getPersonalInformation()->getMobileNo(),
                    ]);
            ...
            //var_dump($this->getErrorMessageForException($e),null);die();
    ...
    public function notifyCustomer($params){
        //file_put_contents(__DIR__."/ex.txt", json_encode($params));        
        \Hook::exec('actionCustomerAccountAdd',$params); 
    }
    ...
    private function getErrorMessages(Exception $e)
    {
        return [
            ...
            DuplicateCustomerMobileNoException::class => sprintf(
                '%s %s',
                $this->trans('An account already exists for this mobile no:', 'Admin.Orderscustomers.Notification'),
                $e instanceof DuplicateCustomerMobileNoException ? $e->getMobileNo() : ''
            ),           
