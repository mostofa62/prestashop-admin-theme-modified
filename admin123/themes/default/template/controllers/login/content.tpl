...
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center">
			<img id="logo" src="http://arkylus.com/img/Brand-Logo.png" width="80px" height="80px" alt="Arkylus" />
		</h1>
	...
	<div id="login-footer">
		<p class="text-center text-muted">
			<a href="http://arkylus.com/" onclick="return !window.open(this.href);">
				&copy; Arkylus&#8482; 2013-{$smarty.now|date_format:"%Y"} - All rights reserved
			</a>
		</p>
		<p class="text-center">
			<a class="link-social link-twitter _blank" href="https://twitter.com/arkylus" title="Twitter">
				<i class="icon-twitter"></i>
			</a>
			<a class="link-social link-facebook _blank" href="https://www.facebook.com/arkylus" title="Facebook">
				<i class="icon-facebook"></i>
			</a>
			<a class="link-social link-github _blank" href="https://www.github.com/arkylus" title="Github">
				<i class="icon-github"></i>
			</a>
			<a class="link-social link-google _blank" href="https://plus.google.com/+arkylus/" title="Google">
